...
public class ReflectionsTest {
    ...
    public void shouldThrowAnException() {
        NoEmptyConstructor instance = Reflections.createInstance(NoEmptyConstructor.class);
    }
    ...
    public void shouldExtractGenericType() {
        Field f = Reflections.getField(Person.class, "pets");

        Assert.assertTrue(f.getType().equals(List.class));
        Assert.assertEquals(Reflections.getType(f), Pet.class);
    }
}
